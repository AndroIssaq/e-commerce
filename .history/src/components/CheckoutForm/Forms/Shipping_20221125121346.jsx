    ...
    return (
        ...
        <div className='flex items-center justify-center flex-col gap-[20px]'>
            ...
            <FormProvider {...methods}>
                <form className='flex items-center justify-center flex-wrap w-100% ' onSubmit={methods.handleSubmit(next( data?{...data ,shippingCountry ,shippingSubdivision , shippingOptions}:))} >
