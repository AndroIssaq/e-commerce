...
const Shipping = ({checkoutToken ,setCurrentStep,currentStep}) => {
    ...
    return (
        ...
        <div className='flex items-center justify-center flex-col gap-[20px]'>
            ...
            <FormProvider {...methods}>
                <form className='flex items-center justify-center flex-wrap w-100% ' onSubmit={methods.handleSubmit()} >
                    ...
                    <div  className='w-[100%] flex justify-between items-center px-[40px] gap-[20px]'>
                        <Link to='/cart'> <button className='w-[120px] h-[35px] mt-[30px] rounded-md text-white bg-orange-400'>back to cart</button> </Link>
                        <button onClick={()=>setCurrentStep(currentStep+1)} type={submit} className=' w-[120px] h-[35px] mt-[30px] rounded-md text-white bg-blue-700'>Next</button>
                    </div>
                </form>
    </FormProvider>
    </div>
