            ...
            <FormProvider {...methods}>
                <form className='flex flex-wrap items-center justify-center gap-[20px]'>
                    <div className='flex flex-col '>
                        ...
                        <input type="text" onChange={formik.handleChanges} value={formik.values.firstname} className='border-gray-500 border-2  p-[2px] pl-[10px] text-[15px] w-[200px] rounded-md'/>
                    </div>
                    <div className='flex flex-col '>
