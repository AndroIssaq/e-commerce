        ...
        <div className='flex items-center justify-center flex-col gap-[20px]'>
            ...
            <FormProvider {...methods}>
                <form className='flex items-center justify-center flex-wrap w-100%' >
                    ...
                    <br/>
                    <div  className='w-[100%] flex justify-between items-center px-[40px]'>
                        <button className='w-[120px] h-[35px] mt-[30px] rounded-md text-white bg-yellow-400'>back to cart</button>
