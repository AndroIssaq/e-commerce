    ...
    return (
        ...
        <div className='flex items-center justify-center flex-col gap-[20px]'>
            ...
            <FormProvider {...methods}>
                <form className='flex items-center justify-center flex-wrap w-100% ' >
                    ...
                    <div  className='w-[100%] flex justify-between items-center px-[40px] gap-[20px]'>
                        ...
                        <button onClick={()=>setCurrentStep(currentStep+1)} type={} className=' w-[120px] h-[35px] mt-[30px] rounded-md text-white bg-blue-700'>Next</button>
                    </div>
                </form>
    </FormProvider>
    </div>
