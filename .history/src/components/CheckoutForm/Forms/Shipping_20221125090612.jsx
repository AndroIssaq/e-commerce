...
const Shipping = ({checkoutToken}) => {
    ...
    const countries=Object.entries(shippingCountries).map(([code,name])=>({id:code,label}))
    return (
        <>
                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} sm={6}>
                            ...
                            {Object.entries(shippingCountries).map(Countrie=>{
                                    return(
                                        <MenuItem value={shhippingCountry} onChange={(e)=>setShippingCountry(e.target.value)}>
                                            {Countrie[1]}
                                        </MenuItem>
                                    )
                                })}
