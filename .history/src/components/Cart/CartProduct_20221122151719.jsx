        ...
        <div className='title flex justify-between items-center w-[100%] '>
            ...
            <div className="btns flex items-center justify-between w-[100%]">
                <div className="quantty flex items-center gap-[10px]">
                    <button on className='text-[25px] w-[30px] h-[30px] bg-slate-300 rounded-sm  hover:scale-[1.1] transition duration-300'>-</button> <span>{itemQuantity}</span> <button className='text-[25px] w-[30px] h-[30px] bg-slate-300 rounded-sm hover:scale-[1.1] transition duration-300'>+</button>
                </div>
