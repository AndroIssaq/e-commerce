...
const Cart = ({cart , HandleEmptyCart, removeCartProduct,updateCartProductQuantity}) => {
            ...
            <main>
                <div className='m-auto w-[90%] '>
                    ...
                    <button onClick={()=>removeCartProduct (productid)} className=' w-[100px] h-[30px] bg-red-500 rounded-xl hover:bg-red-400 transition duration-300  text-slate-50'>clear</button>
