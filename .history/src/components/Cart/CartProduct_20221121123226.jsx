        ...
        <div className='title flex justify-between items-center w-[100%] '>
            ...
            <div className="btns flex items-center justify-between w-[100%]">
                <div className="quantty flex items-center gap-[10px]">
                    <button className='text-[25px] w-[30px] h-[30px] bg-slate-300 rounded-sm '>-</button> <span>5</span> <button className='text-[25px] w-[30px] h-[30px] text-slate-50 bg-slate-300 rounded-sm'>+</button>
                </div>
