        ...
        <div className='title flex justify-between items-center w-[100%] '>
            ...
            <div className="btns flex items-center justify-between w-[100%]">
                <div className="quantty flex items-center gap-[10px]">
                    <button className='text-[25px] w-[30px] h-[30px] bg-slate-300 rounded-sm '>-</button> <span>5</span> <button className='text-[25px] w-[30px] h-[30px] bg-slate-300 rounded-sm'>+</button>
                </div>

                <button className=' w-[100px] h-[30px] bg-red-500 rounded-xl hover:scale-[1.1] text-slate-50'>remove</button>
            </div>
